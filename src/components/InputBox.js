...
import { increaseValue, decreaseValue, setItemQuantity } from "../redux/actions/itemsAction";
...
const InputBox = () => {
  ...
  return (
    <form id='item-input-form'>
      ...
      <input type='text' id='item-name' name='item-name' onChange={(event) => {setNewItemName(event.target.value)}}></input>
      

      <label htmlFor='quantity'>Quantity:</label>
      {/* <input type='number' id='quantity' name='quantity' onChange={(event) => {setItemQuantity(event.target.value)}}></input> */}
